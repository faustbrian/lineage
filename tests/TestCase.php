...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function defineEnvironment($app): void
    {
        ...
        $app['config']->set('lineage.snapshots.enabled', true);
        $app['config']->set('lineage.snapshots.table_name', 'hierarchy_snapshots');
        $app['config']->set('lineage.snapshots.context_morph_type', env('LINEAGE_SNAPSHOTS_CONTEXT_MORPH_TYPE', 'morph'));
        $app['config']->set('lineage.snapshots.ancestor_key_type', env('LINEAGE_SNAPSHOTS_ANCESTOR_KEY_TYPE', 'id'));
    }
